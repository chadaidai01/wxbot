...
def submit_config():
    ...
    try:
        ...
        # 处理API Key字段的特殊逻辑
        api_key_fields = ['DEEPSEEK_API_KEY', 'MOONSHOT_API_KEY', 'ONLINE_API_KEY', 'ASSISTANT_API_KEY', 'FORUM_API_KEY', 'IMAGE_GEN_API_KEY']
        ...
        boolean_fields = [
            ...
            'ENABLE_TEXT_COMMANDS', 'ENABLE_AUTO_PAT_BACK', 'ENABLE_BOMBING', 'ENABLE_IMAGE_GEN',
            'ENABLE_ROLLPIG', 'ENABLE_STARRAIL', 'ENABLE_IMAGE_USE_CHAT_API'
        ]
