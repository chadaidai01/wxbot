...
const panelApi = require( '../runtime/PanelApi.js')
const fetch = require( 'node-fetch')
const MysSRApi = require( '../runtime/MysSRApi.js')
const _ = require( 'lodash')
const fs = require( 'fs')
const path = require( 'path')
const { pluginRoot, pluginResources } = require( '../utils/path.js')
const { findName } = require( '../utils/alias.js')
const getSign = require( '../utils/auth.js')
...
class Panel extends plugin {
  ...
  async panel (e) {
    e = this.e
    let messageReg = new RegExp(`^星铁(.+)面板(更新)?`)
    const matchResult = e.content.match(messageReg)
